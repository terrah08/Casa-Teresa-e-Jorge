...
const PRICE_TYPES = [
  ...
  { id: "30_din", label: "Dinheiro R$30", sub: "Dupla", price: 30, people: 2, kind: "Dinheiro" },
  ...
  { id: "30_cart", label: "Cartão R$30", sub: "Dupla", price: 30, people: 2, kind: "Cartão" },
  ...
  { id: "30_pix", label: "Pix R$30", sub: "Dupla", price: 30, people: 2, kind: "Pix" },
